...
export default function HelpfulWidget() {
  ...
  return (
    <div className="flex items-center gap-3 py-4 border-t border-gray-100 dark:border-gray-800">
      <span className="text-sm text-gray-500 dark:text-gray-400">Was this solution helpful?</span>
      <button
        onClick={() => setVote('up')}
        aria-label="Yes, helpful"
        className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-green-400 hover:text-green-600 hover:bg-green-50 dark:hover:border-green-600 dark:hover:text-green-400 dark:hover:bg-green-950/30 transition-all"
      >
